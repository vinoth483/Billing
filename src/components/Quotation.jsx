...
<FormControl fullWidth margin="dense">
  ...
  >
    ...
    <MenuItem value="ANAND SCIENTIFIC COMPANY">ANAND SCIENTIFIC COMPANY</MenuItem>
    <MenuItem value="VIRIYA SCIENTIFIC COMPANY">VIRIYA SCIENTIFIC COMPANY</MenuItem>
    <MenuItem value="Precision Scientific">Precision Scientific</MenuItem>
  </Select>
</FormControl>
...
{selectedCompany && (
  <PDFDownloadLink
    document={
      selectedCompany === "ANAND SCIENTIFIC COMPANY" ? (
        <Anand companyName={selectedCompany} invoiceTo="Client XYZ" date="02-Feb-2025" />
      ) : selectedCompany === "VIRIYA SCIENTIFIC COMPANY" ? (
        <ViriyaQut  />
      ) : selectedCompany === "Precision Scientific" ? (
        <Precision  />
      ) : null
    }
