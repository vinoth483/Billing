...
const handleSaveAs = async () => {
  try {
    console.log("Save As option clicked");
    ...
    await writable.write("Sample text file content"); // Change this content as needed
    await writable.close();

    console.log("File saved successfully!");
    alert("File saved successfully!"); // Confirm to the user
  } catch (error) {
    ...
    <div className="popup-grid"
      ...
      <FormControl fullWidth margin="dense">
        ...
        <Select
          ...
          <MenuItem value="CSV">Orginal</MenuItem>
          <MenuItem value="EXL">Sample</MenuItem>
        </Select>
      </FormControl>
      <div>
        <input
...
<FormControl fullWidth margin="dense">
  ...
  >
    ...
    <MenuItem value="VIRIYA SCIENTIFIC COMPANY">VIRIYA SCIENTIFIC COMPANY</MenuItem>
    <MenuItem value="RAKAS SCIENCE HOUSE">RAKAS SCIENCE HOUSE</MenuItem>
    <MenuItem value="LIGHTNING SCIENTIFIC INDUSTRY">LIGHTNING SCIENTIFIC INDUSTRY</MenuItem>
  </Select>
</FormControl>
      <FormControl fullWidth margin="dense">
  ...
  <PDFDownloadLink
    document={
      selectedCompany === "VIRIYA SCIENTIFIC COMPANY" ? (
        <Viriya companyName={selectedCompany} invoiceTo="Client XYZ" date="02-Feb-2025" />
      ) : selectedCompany === "RAKAS SCIENCE HOUSE" ? (
        <InvoicePDF  />
      ) : selectedCompany === "LIGHTNING SCIENTIFIC INDUSTRY" ? (
        <LightingSc  />
      ) : null
    }
  ...
  >
    {({ loading }) => (
      ...
      >
        {loading ? "Loading PDF..." : "Save & Export"}
      </Button>
    )}
  </PDFDownloadLink>
)}
