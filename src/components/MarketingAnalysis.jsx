  ...
  return (
    <div className="marketAnalysis-container">
      ...
      <div className="marketAnalysis-actions">
        ...
        className="marketAnalysis-greeting-btn">Greeting Mail</Button>
        <Button variant="contained"  sx={{
            backgroundColor: " #2b356bd3 ",
            color: "white",
            width: "400px",
          }} 
        className="marketAnalysis-new-client-btn">+ New Client</Button>
        <Button variant="contained"  sx={{
            backgroundColor: " #2b356bd3 ",
            color: "white",
            width: "400px",
          }} 
        className="marketAnalysis-export-btn">Export</Button>
      </div>
