...
import "../style/invoice2.css"; // Ensure this CSS file is in the same folder or update the path
import logo from "../assets/RAKAS B_300xx.png"; // Update the path to match your project structure

const Invoice = () => {
  return (
    <div className="rakas-invoice-container">
      <header className="rakas-header">
        <div className="rakas-header-top">
          <div className="rakas-logo">
            <img src={logo} alt="Company Logo" />
          </div>
          <div className="rakas-invoice-title">
            <h1>Invoice</h1>
          </div>
        </div>
      </header>
      <main>
        <div className="rakas-invoice-info">
          <div className="rakas-billed-by">
            <h2>Billed By</h2>
          ...
          <div className="rakas-invoice-details">
      ...
      <footer className="rakas-footer">
        <div className="rakas-terms">
        ...
        <div className="rakas-totals">
          <table className="rakas-totals-table">
            <tr>
              <td>Sub Total</td>
              <td>₹38,858.00</td>
            </tr>
        ...
        <div className="rakas-bank-details">
          <h3>Bank Details</h3>
        ...
        <div className="rakas-page-footer">
          <div className="rakas-footer-details">
            <p><strong>Invoice No:</strong> 00218</p>
            <p><strong>Invoice Date:</strong> 07 Jan 2025</p>
            <p><strong>Billed To:</strong> ALAM ALLOYS</p>
          </div>
          <div className="rakas-page-number">
            <p>Page 1 of 2</p>
          </div>
          <div className="rakas-note">
