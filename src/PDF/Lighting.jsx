...
const Quotation = () => {
  return (
    <div className="lighting-quotation">
      ...
      <table className="lighting-spec-table">
        <tbody>
          <tr>
      ...
      <table className="lighting-price-table">
        <thead>
          <tr>
